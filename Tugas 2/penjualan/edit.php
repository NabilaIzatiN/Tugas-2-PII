<?php
$id = $_GET['kode_jual']; include 'model.php';
$model = new Model();
$data = $model->edit($id);
?>
<!doctype html>
...
<title>Edit Data Penjualan Parfume</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-secondary bg-dark">
  ...
  <h1>Edit Data Penjualan Parfume</h1></a>
...
<input type="hidden" name="kode_penjualan" value="<?php echo $data->kode_jual ?>">
    <label>Merk Parfume</label>
    
    <input class="form-control" type="hidden" name="kd_parfume" value="<?php echo $data->kd_parfume ?>" readonly>
    <input class="form-control" type="text" name="merk" value="<?php echo $data->merk ?>" readonly>
</div>
...
<div class="text-right">
    ...
    <button type="submit" name="submit_edit" class="btn btn-light">Submit</button>
</div>
